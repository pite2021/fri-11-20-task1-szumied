...
class Car:
    ...
    def print_status(self):
        print(f"[Speed: {self.speed}, wheel angle: {self.wheel_angle}] {self.status}")
    ...
    def wait(self, speed):
        print(f"[Speed: {self.speed}, wheel angle: {self.wheel_angle}] Waiting.")
...
events_list = [
    ...
    Event('Fantasize about street racing', 4, [
        lambda car: car.modify_speed(100)
    ])
]
